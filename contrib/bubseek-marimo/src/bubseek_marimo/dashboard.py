"""Marimo dashboard template — native marimo chat + index."""

DASHBOARD_TEMPLATE = '''"""Bubseek Marimo dashboard — native marimo chat + insights index."""
...
def _():
    ...
    chat_request_timeout_seconds = __BUBSEEK_CHAT_REQUEST_TIMEOUT_SECONDS__
